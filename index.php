...
<section id="banner">
	<div class="owl-carousel owl-theme">
	    <div class="item">
	    	<div class="single_banner" style="background: url(images/banner3.jpg);">
	    		<div class="content">
	    			<h2 class="wow bounce">Construction Services<br><span>Creative & Professional</span></h2>
	    			<p class="wow slideInLeft">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit,</p>
		...
		<div class="row">
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
				<div class="about_content">
					<h2 class="wow slideInDown" data-wow-duration=".8s" data-wow-delay=".5s">WELCOME TO <span>OUR COMPANY</span></h2>
					<h5>Lorem Ipsum is simply dummy text....</h5>
					<hr>
					<p class="wow slideInDown" data-wow-duration=".8s" data-wow-delay="">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
	...
	<div class="container">
		<div class="row">
			...
			<div class="service_content">
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<a href="#" class="single_service wow slideInRight" data-wow-duration=".6s" data-wow-delay=".3s">
						<div class="service_img">
...
<section id="gallery" style="background: url(images/gallery.jpg);">
	<div class="container">
		<div class="row gallery">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 gattor wow slideInUp" data-wow-duration=".5s" data-wow-delay=".3s">
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 gattor wow slideInUp" data-wow-duration=".5s" data-wow-delay=".3s">
					<a href="images/gallery3.jpg" target="_blank" >
						<img src="images/gallery3.jpg" alt="" class="img-responsive">
					</a>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 gattor wow slideInUp" data-wow-duration=".5s" data-wow-delay=".3s">
					<a href="images/gallery4.jpg" target="_blank" >
						<img src="images/gallery4.jpg" alt="" class="img-responsive">
					</a>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 gattor wow slideInUp" data-wow-duration=".5s" data-wow-delay=".3s">
					<a href="images/gallery5.jpg" target="_blank" >
						<img src="images/gallery5.jpg" alt="" class="img-responsive">
					</a>
				</div>
			    ...
			    <div class="item">
			    	<div class="single_customer">
			    		<div class="customer_content">
			    			<p><span><img src="images/qute.png" alt=""></span> Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit,</p>
			    		</div>
			    		<div class="user_id">
